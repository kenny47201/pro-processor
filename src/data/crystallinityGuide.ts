    ...
    /* ───────── Section 1: Executive Summary (Manual §A, pp 3–4) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          figureNumber: 'Cover Visual',
          caption: 'Degree of crystallinity changes mechanical, thermal, and optical behavior. (Master Training Manual, Page 1)',
        },
        {
          type: 'paragraph',
        ...
        },
        {
          ...
          rows: [
            ['Material', 'Polymer family, grade, molecular weight, copolymer content, nucleation package, fillers, fibers, moisture, regrind, colorant, flame retardant.', 'Material chemistry decides whether crystallization can occur and how fast it occurs.'],
            ['Process', 'Melt temperature, mold temperature, injection speed, transfer position, pack pressure, hold time, cooling time, residence time, screw recovery, back pressure, drying, cycle stability.', 'These variables define the path through the crystallization window and decide how much packing is transmitted before the gate stops accepting material.'],
            ['Mold', 'Gate type/size/location, wall thickness, cooling layout, core/cavity balance, baffles/bubblers, venting, flow length, texture, hot spots, stack-mold thermal path.', 'The mold defines local heat extraction, shear history, pressure loss, frozen layer growth, and cavity-to-cavity thermal variation.'],
            ['Machine/Equipment', 'Screw, non-return valve, heater bands, thermocouples, nozzle, hot-runner controller, TCU, chiller, coolant flow, cavity pressure sensors.', 'Equipment condition decides whether the nominal setup actually creates the intended melt state, pressure transmission, and mold-surface temperature.'],
          ],
        },
        {
          type: 'paragraph',
    ...
    /* ───────── Section 2: Foundations (Manual §B, pp 5–6) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption: 'Molecular chain with amorphous region and crystalline lamella: the same long chain can contain ordered and disordered segments. (Master Training Manual, Page 6)',
        },
        {
          type: 'table',
    ...
    /* ───────── Section 3: Polymer Science Fundamentals (Manual §C, p 7) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Chain regularity', 'Regular repeat units and consistent stereochemistry allow neighboring segments to approach and pack. Irregular architecture suppresses lattice formation.'],
            ['Tacticity', 'Isotactic or syndiotactic arrangement can promote crystallinity; atactic randomness usually suppresses crystallization. PP is the shop-floor example.'],
            ['Branching', 'Branching interrupts chain packing. HDPE crystallizes more readily than LDPE because it has less branching.'],
            ['Copolymer content', 'Random comonomers disrupt regularity, slow crystallization, lower melting behavior, and alter shrinkage. Impact copolymer PP is not the same as homopolymer PP.'],
            ['Molecular weight', 'Higher MW increases entanglement and may slow diffusion, but can increase tie-molecule population and toughness. Degradation lowers MW and can change crystallization rate and failure mode.'],
            ['Molecular weight distribution', 'Broad distributions contain short chains that crystallize more readily and long chains that resist diffusion. Processing behavior may change lot to lot.'],
            ['Chain mobility', 'Crystals form only if segments can move. Above Tg the amorphous phase gains mobility; near Tm crystals melt; in the crystallization window mobility and driving force overlap.'],
            ['Supercooling', 'Crystallization usually occurs below the equilibrium melting point. More supercooling increases driving force but too much cooling immobilizes the chains.'],
            ['Nucleating agents', 'Provide many stable starting points. More nuclei usually mean faster crystallization and smaller spherulites.'],
            ['Fillers and fibers', 'Can nucleate crystals and constrain shrinkage. Fibers also create anisotropic shrinkage due to orientation.'],
            ['Moisture', 'In hygroscopic polymers, moisture can plasticize the amorphous phase and, if severe, cause hydrolysis that permanently reduces molecular weight.'],
            ['Thermal history', 'Prior melt exposure, regrind, hot-runner dwell, shutdowns, and drying history change viscosity, nucleation, degradation, and crystallization behavior.'],
          ],
        },
        {
          type: 'paragraph',
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['2. Melting / Plasticizing', 'Screw rotation conveys, compresses, melts, mixes, and meters resin.', 'Existing crystals melt; crystal memory may be erased or partially retained depending on temperature and residence. Excess heat can degrade the resin.'],
            ['3. Shot Accumulation', 'Melt waits in front of the screw and in hot-runner manifolds/drops/tips.', 'Residence time and local hot spots change molecular weight, colorant stability, nucleation, and viscosity.'],
            ['4. Fill', 'Melt enters cavity under pressure through runner and gate restrictions.', 'Fountain flow puts hot melt against cold steel. High shear near walls and gate orients chains and can trigger flow-induced crystallization.'],
            ['5. Pack / Hold', 'After transfer, pressure feeds more melt while the gate remains open.', 'Compensates crystallization shrinkage and raises local density. Ends when gate seals or valve closes.'],
            ...
            ['7. Ejection', 'Part leaves the mold with residual temperature gradients and stresses.', 'If core remains above a relevant transition or crystallization window, post-mold shrinkage and warp can continue.'],
        ...
        },
        {
          ...
          caption: 'The Microscopic Landscape: Skin-Core Morphology & Crystalline Evolution. (Master Training Manual, Page 9)',
          lookFor: {
            tone: 'info',
    ...
    /* ───────── Section 5: Semi-Crystalline vs Amorphous (Manual §E, p 10) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Thermal behavior', 'Have a true melting range (Tm) and usually a Tg. Crystals melt at Tm.', 'Have Tg but no normal crystalline melting point. Soften over a range above Tg.'],
            ...
            ['Shrinkage', 'Higher, more time-dependent, often more anisotropic.', 'Usually lower and more predictable, though residual stress can still distort parts.'],
            ['Optics', 'Crystals scatter light; often translucent to opaque.', 'Often clearer when unfilled, dry, and stress-free.'],
            ['Chemical resistance', 'Often stronger — tight packing limits solvent penetration.', 'Often more solvent-sensitive, but chemistry still dominates.'],
    ...
    /* ───────── Section 6: Material-by-Material Behavior (Manual §F, pp 11–13) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['PP homo/copolymer', 'Semicrystalline', 'Tg ≈ -10–0°C; Tm ≈ 160–168°C', '20–80°C', 'Shrinkage, warpage, opacity, gate blush, post-mold drift, stiffness variation'],
            ['HDPE / LDPE', 'Semicrystalline', 'HDPE Tm ≈ 128–136°C; LDPE ≈ 105–115°C', '20–60°C', 'Density change, shrinkage, warpage, thick-section drift'],
            ['PA6 / PA66', 'Semicrystalline, hygroscopic', 'PA6 Tm ≈ 220°C; PA66 Tm ≈ 255–265°C; dry Tg ≈ 50–70°C', '60–100°C', 'Moisture effects, hydrolysis, post-mold conditioning, brittle dry parts'],
            ['POM / Acetal', 'Semicrystalline', 'Tm ≈ 165–180°C; Tg below room temp', '80–120°C', 'High shrinkage, voids/sink if underpacked, formaldehyde risk'],
            ['PBT', 'Semicrystalline polyester', 'Tm ≈ 220–225°C; Tg ≈ 40–50°C', '40–100°C', 'Hydrolysis, glass-fiber anisotropy, warp, poor surface'],
            ...
            ['PPS', 'Semicrystalline high-perf', 'Tm ≈ 280–285°C; Tg ≈ 85–90°C', '120–160°C', 'Under-crystallized skins, weld weakness, brittle response'],
            ...
            ['PC/ABS', 'Amorphous blend', 'Blend Tg; no practical Tm', '60–100°C', 'Weld strength, gloss, stress, paint/plate performance'],
            ['SAN / PMMA', 'Amorphous', 'Tg ≈ 100–110°C', '40–80°C', 'Optical stress, cracking, flow marks, surface replication'],
            ['TPU / TPE', 'Grade-dependent', 'Hard/soft segment dependent', 'Supplier-specific', 'Do not generalize; evaluate supplier morphology target'],
            ['Filled / reinforced', 'Matrix-dependent', 'Matrix values modified by filler/fiber', 'Matrix and supplier-specific', 'Anisotropic shrink, fiber orientation, nucleation, warpage'],
          ],
        },
        ...
        { type: 'heading', level: 3, text: 'F.8 Filled, Reinforced, Flame-Retarded, Colored, and Regrind Grades — Page 13' },
        {
          type: 'paragraph',
    ...
    /* ───────── Section 7: Visual Appearance (Manual §G, pp 14–15) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption: 'Cooling rate effect: slow cooling gives chains time to organize; rapid quenching traps more disorder. (Page 14)',
        },
        {
          type: 'image',
          ...
          caption: 'Spherulite structure: crystalline lamellae radiate from nuclei with amorphous tie chains between ordered regions. (Page 14)',
        },
        {
          type: 'image',
          ...
          caption: 'General property trends with increasing crystallinity: stiffness and tensile strength rise, transparency falls, and melting behavior becomes more pronounced. (Page 15)',
        },
        {
          type: 'table',
          ...
          rows: [
            ['Microscope / PLM', 'Spherulites, skin-core layers, Maltese-cross patterns, lamellar aggregates, orientation bands.', 'Use microtomed sections from gate, end-of-fill, thick and thin zones.'],
            ['Appearance', 'Opacity, haze, gloss shift, flow bands, gate halo, differential texture replication.', 'Visual signs are indirect; verify with density, DSC, microscopy, or shrink map.'],
            ['Dimensional map', 'High-shrink zones, post-mold drift, differential warp, thick-section contraction.', 'Map at ejection, 24 h, 72 h, and after heat/humidity conditioning.'],
            ['Fracture surface', 'Brittle inter-spherulitic fracture, ductile tearing, fiber pullout, weld-line failure.', 'Fracture is often mixed with degradation, moisture, notch, and weld quality.'],
            ['Cavity pressure trace', 'Gate seal timing, pack effectiveness, pressure decay, end-of-fill pressure.', 'Correlate process signature to measured weight, dimensions, and morphology.'],
          ],
        },
        {
          type: 'callout',
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['Linear shrinkage', 'Usually increases; anisotropy may increase with flow/fiber orientation.', 'Usually lower but frozen stress may relax later.', 'Always map flow, cross-flow, thickness, and cavity-to-cavity.'],
            ...
            ['Creep resistance', 'Usually improves — crystals resist chain slippage.', 'Usually worse at elevated temperature.', 'Long-term load and service temperature matter.'],
            ...
            ['Barrier behavior', 'Often improves — crystals create tortuous diffusion paths.', 'Usually weaker barrier.', 'Orientation and fillers can alter result.'],
            ['Friction / Wear', 'Often improves in POM, PA, PEEK, PE, PPS.', 'May be poorer or more temperature-sensitive.', 'Wear grades include lubricants/fillers that complicate interpretation.'],
            ...
            ['Surface finish', 'Can improve or worsen depending on mold temp, spherulite size, shrinkage.', 'Often easier to achieve high gloss if stress is managed.', 'Surface is a skin phenomenon; bulk Xc may not explain it.'],
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['Barrel profile', 'Hotter front/nozzle may improve fill but can overheat drool-prone materials.', 'Too cool may leave unmelt or high shear.', 'Use resin-specific profiles; verify melt homogeneity.'],
            ['Nozzle temperature', 'Reduces nozzle freeze, can increase stringing and gate blush.', 'Can cause cold slug, short shots, weak welds.', 'Check actual nozzle and tip condition.'],
            ...
            ['Cushion', 'Too large may add residence and variability.', 'Too small can bottom out and lose pack control.', 'Trend cushion consistency as machine health indicator.'],
            ...
            ['Coolant flow / TCU', 'More turbulent flow improves heat removal and consistency.', 'Low flow/fouling causes hot spots and cavity variation.', 'Record supply/return temps and flow.'],
            ...
            ['Decompression / Suckback', 'Can pull air/moisture, cause splay if excessive.', 'Drool/stringing risk if too low.', 'Do not mask hot tip problems with excessive decompression.'],
            ['Cycle time variation', 'Long cycles overcool parts and overheat hot runners.', 'Short cycles eject hot, underdeveloped cores.', 'Segregate interruption shots.'],
            ...
            ['Drying conditions', 'Overheating/overdrying can degrade or age material.', 'Underdrying causes moisture defects/hydrolysis.', 'Document time, temp, dew point, airflow.'],
            ['Material lot variation', 'New lot may crystallize differently even at same settings.', 'Old lot/regrind mix may behave differently.', 'Qualify lots with part weight, dimensions, and critical tests.'],
            ['Hot-runner zone temps', 'Overhot tips cause drool, stringing, lower gate Xc, degradation.', 'Too cold tips cause freeze, shorts, pressure spikes.', 'Trend each zone and compare actual gate condition.'],
            ['Valve-gate timing', 'Later close allows more pack; too late can overpack or mark.', 'Earlier close isolates cavity before shrink compensation.', 'Validate by cavity weight, pressure, and dimensions.'],
          ],
        },
        {
          type: 'callout',
    ...
    /* ───────── Section 10: Cold vs Hot Runner (Manual §J, pp 18–19) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption: 'Gate freeze-off kinetics and runner-system comparison. Weight-vs-hold-time plateau identifies natural gate seal in freeze-controlled systems. (Page 18)',
        },
        {
          type: 'table',
          ...
          rows: [
            ['Thermal history', 'Sprue/runner/gate cool every shot; less continuous hot dwell.', 'Manifold/drops/tips keep resin molten; added heated residence.', 'Hot runner delivers warmer, steadier melt but adds degradation risk.', 'Audit total residence including hot runner volume and stoppages.'],
            ['Gate seal', 'Physical freeze of gate land — clear and weight-study friendly.', 'Open tips seal by viscosity/pressure; valve gates seal mechanically.', 'Changes pack window and gate-area crystallinity.', 'Run gate-seal studies appropriate to gate type.'],
            ['Pack transmission', 'Limited by progressive runner/gate freeze.', 'More direct hydraulic connection while manifold is molten.', 'Hot runner may pack more efficiently and consistently.', 'Balance manifold and cavity weights.'],
            ['Residence degradation', 'Shorter hot exposure but regrind adds heat history.', 'Long exposure possible, especially slow cycles and stoppages.', 'MW and nucleation behavior can drift.', 'Use standby, purge, and residence-time limits.'],
            ['Regrind', 'Runner scrap reused; changes nucleation, moisture, degradation.', 'Minimal runner scrap; less regrind pressure.', 'Cold runner with uncontrolled regrind has more material-state variation.', 'Specify regrind %, dryness, segregation, max heat history.'],
            ['Gate-zone crystallinity', 'Gate cools from steel; moderate/high Xc near frozen gate.', 'Heated gate can delay crystallization or create amorphous halo.', 'Local properties near gate may differ from body.', 'Section gate areas when failures start near gate.'],
            ['Thermal control', 'Simpler tooling; cooling balance still critical.', 'Many heaters, TCs, tips, valve pins, controllers.', 'Hot runner consistent only when in equilibrium and healthy.', 'Trend zones and reject startup/transition shots.'],
            ['Cycle time', 'Runner cooling can dominate cycle.', 'No cold runner cooling burden; cavity cooling remains.', 'Hot runner may shorten cycle but increases thermal burden.', 'Do not sacrifice part stability for cycle rate.'],
            ['Color/material change', 'Runner purged mechanically but scrap is high.', 'Dead spots/manifold residence can extend transition.', 'Contamination or old material can alter Xc.', 'Use documented purge sequence and first-shot quarantine.'],
            ['Stack/family molds', 'Geometric balance important; thermal path differences still matter.', 'Thermal and rheological balance are critical; hot drops may vary.', 'Cavity-to-cavity morphology spread can increase.', 'Weight, pressure, and dimensional data must be cavity-specific.'],
          ],
        },
        {
          type: 'paragraph',
    ...
    /* ───────── Section 11: Mold & Equipment (Manual §K + §L, pp 20–21) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Gate type', 'Controls shear, pressure drop, seal mechanism, vestige temp.', 'Small tunnel: fast freeze/high shear; Fan: lower shear; Valve: mechanical seal.', 'Select gate based on pack window and morphology, not only trim convenience.'],
            ['Gate size / land', 'Controls gate freeze time and pressure loss.', 'Undersized: early seal, underpack, sink/voids. Oversized: delay seal.', 'Run gate-freeze and pressure-drop studies before locking.'],
            ['Gate location', 'Sets flow length, weld placement, fiber orientation, gate-zone morphology.', 'Near-gate sees highest heat/shear; end-of-fill may quench and weld poorly.', 'Place gates to balance shrink, weld strength, and critical dimensions.'],
            ...
            ['Cooling channels', 'Control mold-surface temperature and local gradients.', 'Far/blocked/uneven channels create hot spots and Xc variation.', 'Design for turbulent flow, balanced circuits, measured flow.'],
            ...
            ['Venting', 'Poor venting causes burns, shorts, hesitation, weak welds.', 'Hesitation cools local melt and changes structure.', 'Maintain vent depth, clean vents, evaluate trapped gas.'],
            ['Flow leaders/deflectors', 'Alter fill pattern and local shear/cooling.', 'Can improve balance or create new orientation gradients.', 'Simulate and confirm with short shots and cavity pressure.'],
            ['Texture/polish', 'Affects surface heat transfer, replication, gloss, and ejection.', 'Rough textures may require higher mold temp or pack.', 'Validate appearance and dimensions together.'],
            ['Ejection design', 'Hot, under-crystallized cores deform during ejection.', 'Pins can mark or distort semi-solid areas.', 'Use adequate cooling and ejection area; verify ejection temp.'],
          ],
        },
        {
          type: 'callout',
        ...
        },
        {
          ...
          rows: [
            ['Screw design/compression', 'Melt quality, shear heat, unmelt risk, residence.', 'Affects Xc through melt homogeneity and thermal history.'],
            ['Mixing section', 'Color/additive distribution; can add shear heat.', 'Poor mixing creates local nucleation/color variation; excessive mixing can degrade.'],
            ['Non-return valve', 'Shot and pack consistency.', 'Worn NRV causes weight/density variation mimicking Xc scatter.'],
            ['Screw/barrel wear', 'Plasticizing consistency and melt control.', 'Changes shear heat, residence, and shot repeatability.'],
            ...
            ['Hot-runner controller', 'Manifold, drops, tips, valve gates.', 'Zone drift creates cavity-specific thermal history.'],
    ...
    /* ───────── Section 12: Defects & Troubleshooting (Manual §M, p 22) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Warpage', 'Differential Xc and shrinkage from uneven cooling, wall thickness, pack, or fiber orientation.', 'Uneven pack, mold distortion, ejection, handling, fiber orientation.', 'Map mold surface temps, part weight, dimensions over time; section part.', 'Balance cooling, correct wall transitions, establish gate seal, adjust pack.'],
            ['Sink marks', 'Core crystallization shrink not compensated before gate seal.', 'Low pack pressure, short hold, thick section, small gate.', 'Weight-vs-hold-time study; cross-section for voids.', 'Increase pack before gate seal, enlarge gate, reduce thick mass.'],
            ...
            ['Brittleness', 'Coarse spherulites, low tie molecules, under-crystallization with stress, or over-crystallized brittle morphology.', 'Degradation, contamination, dry PA, notch, weld weakness.', 'DSC/density plus impact/tensile, moisture, melt-flow shift.', 'Correct drying/dwell, mold temp, nucleation, gate/weld design.'],
            ...
            ['Differential gloss', 'Skin crystallinity, texture replication, cooling rate, shear.', 'Mold polish, contamination, venting, velocity marks.', 'Compare gloss map to flow and thermal map.', 'Adjust mold temp/velocity/gate, clean mold/vents.'],
            ['Gate blush / Halo', 'Local shear orientation and thermal gradient near gate.', 'Too small gate, high velocity, hot tip, material shear sensitivity.', 'Short shot, gate pressure, microscopy near gate.', 'Increase gate, profile speed, adjust tip temp.'],
            ...
            ['Splay', 'Not normally a crystallinity defect.', 'Moisture, hydrolysis, volatiles, degradation, air.', 'Moisture test, purge inspection, drying audit.', 'Dry properly, reduce degradation, fix decompression/venting.'],
            ['Short shots / Hesitation', 'Premature freeze can suppress full morphology and pack.', 'Pressure limit, cold slug, vent block, poor transfer.', 'Fill study and pressure trace.', 'Raise melt/mold carefully, improve venting, check gate/nozzle.'],
    ...
    /* ───────── Section 13: Diagnostic Methods (Manual §N, p 23) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Visual inspection', 'Indirect appearance clues.', 'Fast, free, good for mapping.', 'Cannot quantify Xc; easily confused.', 'First-pass screening.'],
            ['Part weight vs hold time', 'Mass accepted before gate seal.', 'Excellent for gate-freeze and pack optimization.', 'Does not isolate crystallinity alone.', 'Scientific molding setup.'],
            ['Shrink / dimensional map', 'Geometry response over time and location.', 'Directly linked to customer risk.', 'Needs conditioning plan.', 'Validation and troubleshooting.'],
            ['Density / specific gravity', 'Bulk density related to crystalline packing.', 'Relatively fast and inexpensive.', 'Voids, fillers, moisture confound.', 'Comparative QA and development.'],
            ['DSC', 'Thermal transitions, melting/crystallization enthalpy.', 'Primary quantitative method for Xc.', 'Needs correct references and filler correction.', 'Lab confirmation and DOE.'],
            ['XRD', 'Crystalline phase/order and orientation.', 'Strong structural evidence.', 'Higher cost/skill; sample prep matters.', 'Failure analysis and research.'],
            ['Polarized light microscopy', 'Spherulites, skin-core, orientation bands.', 'Best for local morphology.', 'Destructive; skilled interpretation.', 'Root-cause and training.'],
            ['FTIR / Raman', 'Spectral indicators of ordering.', 'Surface-sensitive; useful for high-perf polymers.', 'Requires calibration.', 'PEEK/PAEK and comparative analysis.'],
            ['Cavity pressure / temperature', 'Real-time pressure and thermal fingerprint.', 'Best in-process view of gate seal and pack.', 'Requires instrumented tool.', 'Process validation and monitoring.'],
            ['Simulation', 'Predicted fill, pack, cooling, shrink, warp.', 'Good design comparison before steel changes.', 'Material model quality dominates.', 'DOE planning and mold design.'],
          ],
        },
        {
          type: 'callout',
    ...
    /* ───────── Section 14: Process Development (Manual §O, p 24) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Viscosity study', 'Fill speed / flow rate', 'Material, melt, mold temp, transfer', 'Peak pressure, fill pressure, fill time', 'Choose stable velocity region.'],
            ['Cavity balance', 'Shot size / short-shot progression', 'Velocity profile, temps', 'Cavity fill progression, weights', 'Find imbalance and flow restrictions.'],
            ['Pressure drop', 'Sequential flow path measurement', 'Velocity, temps', 'Pressure at machine/cavity', 'Confirm pressure budget.'],
            ['Gate seal', 'Hold time', 'Pack pressure, fill, temps', 'Part weight plateau, cavity pressure', 'Set hold time and evaluate gate size.'],
            ['Mold temperature sweep', 'Mold surface temperature', 'Fill/pack/cooling initially', 'Dimensions, Xc, shrink, appearance', 'Choose crystallinity/cycle balance.'],
            ['Cooling study', 'Cooling time', 'Fill/pack/mold temp', 'Ejection temp, drift, warp', 'Minimum stable cooling time.'],
            ['DOE', 'Two or more key variables', 'Material/machine/mold state', 'Critical-to-quality metrics', 'Robust window and interactions.'],
          ],
        },
      ],
    },
    ...
    /* ───────── Section 15: Case Studies (Manual §P, p 25) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['POM precision gear drift', 'Gears met dimensions at ejection but failed after storage.', 'Low mold temp and insufficient hold left hot cores under-crystallized and underpacked.', 'Weight plateau late; density low; dimensions changed after 72 h.', 'Raised mold temp within supplier band, extended hold to gate seal, increased cooling, validated with density and aging.'],
            ['PP cap warpage in multi-cavity tool', 'Two cavities ran oval while others were stable.', 'Cooling imbalance plus regrind % variation changed local Xc and shrink.', 'Cavity-specific weights and IR mold map showed hotter cores.', 'Cleaned cooling circuits, balanced flow, controlled regrind, reset pack by cavity weight.'],
            ['PA66 housing brittleness', 'Parts cracked during snap-fit assembly.', 'Dry-as-molded condition, possible hydrolysis from poor drying, high stress from cold mold.', 'Moisture high before drying; impact failed; DSC/density indicated low variable development.', 'Dried to spec, reduced residence, increased mold temp, validated conditioned properties.'],
            ['PBT connector warp', 'Glass-filled connector bowed after reflow/heat exposure.', 'Fiber orientation plus nonuniform crystallinity and low tool temp created delayed movement.', 'Warp worsened after thermal exposure; microscopy showed skin-core imbalance.', 'Adjusted gate/packing, raised mold temp, improved cooling balance, added heat-aging validation.'],
            ['Hot-runner PP gate halo', 'Gloss/opacity halo around gate on only two drops.', 'Hot tip temperature imbalance delayed local crystallization and changed orientation.', 'Problem followed hot-runner zones; cavity weights not identical.', 'Repaired thermocouple/heater, rebalanced tips, profiled injection speed near gate.'],
            ['PEEK high-value part property scatter', 'Parts passed dimensions but failed high-temp modulus requirements.', 'Tool temperature low in one area produced amorphous skin and incomplete crystallization.', 'DSC by location showed Xc difference; surface color/opacity varied subtly.', 'Raised and balanced mold temperature, extended controlled cooling, added DSC release sample plan.'],
          ],
        },
      ],
    },
    ...
    /* ───────── Section 17: Standards & Best Practices (Manual §R, p 27) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['ASTM D3418', 'DSC for transition temperatures and enthalpies of fusion/crystallization.', 'Use for DSC-based Xc, Tm, Tc, and process development.'],
            ['ISO 11357 series', 'DSC general principles and crystallization kinetics methods.', 'Use for DSC procedures, kinetics, and international lab alignment.'],
            ['ASTM D792', 'Density and specific gravity by displacement.', 'Useful for comparative crystallinity/density checks.'],
            ['ISO 1183', 'Density methods for plastics.', 'Alternative density standard in global labs.'],
            ['Supplier data sheets', 'Grade-specific melt, mold, drying, shrink, residence, and safety guidance.', 'Production release must follow grade-specific supplier guidance.'],
            ['Customer control plan', 'Critical dimensions, capability targets, sampling, reaction plan.', 'Defines production acceptance, not crystallinity standards alone.'],
            ['Scientific molding records', 'Viscosity study, pressure drop, gate seal, cooling study, DOE, cavity balance.', 'Best way to connect settings to measured outcomes.'],
          ],
        },
        {
          type: 'callout',
    ...
    /* ───────── Section 18: Quick-Reference Tools (Manual §S, p 28) ───────── */
    {
      ...
      blocks: [
        ...
        { type: 'heading', level: 3, text: 'S.1 Decision Tree: Is This Really a Crystallinity Problem?' },
        {
          ...
          rows: [
            ['1', 'Is the resin semicrystalline in normal injection molding?', 'No: investigate stress, moisture, degradation, venting, pack, or contamination. Yes: continue.'],
            ['2', 'Did the issue follow mold temperature, cooling, cycle time, or hot-runner change?', 'Yes: thermal-history issue likely. Map actual mold surface and gate/tip temperatures.'],
            ['3', 'Did part weight change?', 'Yes: pack/gate seal/material viscosity changed. Run hold-time and weight study.'],
            ['4', 'Did dimensions drift after 24–72 h or heat exposure?', 'Yes: post-mold crystallization or relaxation possible. Validate aging and ejection temp.'],
            ['5', 'Is appearance affected without weight/dimension shift?', 'Check local skin morphology, shear, gate blush, colorant, moisture, texture, or contamination.'],
            ['6', 'Can DSC/density/microscopy confirm the structure difference?', 'If critical, test samples from affected and unaffected locations/cavities.'],
          ],
        },
        { type: 'heading', level: 3, text: 'S.2 First Adjustment Priority Matrix' },
        {
          ...
          rows: [
            ['Sink/voids with low part weight', 'Pack pressure / hold time / gate size', 'Verify gate seal first. Pack only works before gate seal.'],
            ['Warp with cavity-to-cavity variation', 'Cooling balance and cavity weights', 'Do not average all cavities; map each cavity.'],
            ['Dimensional drift after aging', 'Mold temperature, cooling time, ejection temp', 'Consider controlled anneal only after validation.'],
            ['Gate halo/blush', 'Gate shear, tip temperature, velocity profile', 'Changing bulk mold temp may miss root cause.'],
            ['Brittle PA', 'Moisture/drying, residence, mold temp, conditioning', 'Dry-as-molded nylon properties are not final conditioned properties.'],
            ['Hot-runner random defects after stoppage', 'Residence time / purge / hot-runner zones', 'Segregate and purge interruption shots.'],
            ['Opacity variation', 'Mold temp, cooling rate, nucleation/color lot', 'Confirm with DSC/density/microscopy if critical.'],
          ],
        },
      ],
    },
    ...
    /* ───────── Section 19: References (Manual §T, p 29) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['_STEP BY STEP__NO AUTOPILOT__NO FLUFF__METRICS MOD.pdf', 'Original scope/specification: A–U structure, no-fluff posture, metrics, hot-runner/cold-runner through-line, SME checklist.'],
            ['Crystallinity in Injection Molding Guide.docx', 'Compact draft manual: beginner framing, process levers, diagnostics, scientific molding sequence, troubleshooting.'],
            ['Crystallinity in Plastics Injection Molding Guide - DeepSeek.pdf', 'Long-form draft: expanded material behavior, process matrices, validation workflow, startup/shutdown, case studies.'],
            ['Crystallinity_Complete_Technical_Guide.docx', 'Expanded guide: polymer science, runner comparison, process/mold/machine effects, troubleshooting, SME checklist.'],
            ['crystallinity_in_plastics_injection_molding_manual.docx', 'Processor-focused: plain-language, shop-floor action guides, myth-vs-reality, concise tables.'],
            ['$Crystallinity_In_Injection_Molding_Consolidated_Fact_Checked_Teaching_Manual$.pdf', 'Fact-checked consolidated: reference register, corrected claims, material ranges, DSC formula, evidence qualifications.'],
            ['Visual images: degree of crystallinity, gate freeze-off kinetics, lamellae, cooling rate, spherulites, skin-core', 'Embedded visual teaching plates connecting molecular structure to molding outcomes.'],
            ['The_Molecular_Blueprint.pdf / The_Molecular_Blueprint1.pdf', 'Visual storyboard reference for molecular-to-process teaching sequence.'],
          ],
        },
        {
          type: 'paragraph',
    ...
    /* ───────── Section 20: Glossary (Manual Appendix A, p 31) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Annealing', 'Controlled heating after molding to relieve stress or complete crystallization. Can improve stability but may add shrinkage; must be validated.'],
            ['Amorphous', 'Disordered polymer chain arrangement. Amorphous polymers soften through Tg and lack a true crystalline melting point.'],
            ['Cold crystallization', 'Crystallization observed during reheating of an under-crystallized sample, often detected in DSC. Indicates remaining crystallization potential.'],
            ['Crystallization window', 'Temperature band where chain mobility and thermodynamic driving force allow meaningful nucleation and growth.'],
            ['Fountain flow', 'Flow pattern where melt at the center moves forward then rolls outward to contact the mold wall, creating skin formation and orientation.'],
            ['Gate freeze', 'Loss of the ability to feed material through the gate because it solidified or was mechanically closed.'],
            ['Nucleating agent', 'Additive that increases crystal start sites, reducing spherulite size and speeding crystallization.'],
            ['Post-mold shrinkage', 'Dimensional change after ejection from continued crystallization, stress relaxation, thermal contraction, or moisture conditioning.'],
            ...
            ['Skin-core morphology', 'Layered morphology caused by faster cooling and higher shear near mold walls than at the part core.'],
          ],
        },
      ],
    },
    ...
    /* ───────── Section 21: Formula Sheet (Manual Appendix B, p 32) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['DSC crystallinity, unfilled', 'Xc = [(ΔHm − ΔHcc) / ΔHm0] × 100', 'Use same polymer chemistry and reference heat of fusion.'],
            ['DSC crystallinity, filled', 'Xc = [(ΔHm − ΔHcc) / (w_polymer × ΔHm0)] × 100', 'Correct for glass, mineral, carbon black, FR solids, and other nonmelting mass.'],
            ['Weight study gate seal', 'Gate seal time = hold time where part weight plateaus', 'Valid for natural freeze-controlled gates; valve gates require timing logic.'],
            ['Shrinkage', 'Shrinkage % = [(mold dimension − part dimension) / mold dimension] × 100', 'Measure at defined time and conditioning state.'],
            ['Density comparison', 'Higher density generally indicates higher crystallinity when composition and void content are constant', 'Not standalone proof if fillers, voids, moisture, or regrind vary.'],
          ],
        },
      ],
    },
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['15–35 min', 'Molding cycle walkthrough: pellet, melt, fill, pack, cooling, ejection, post-mold conditioning.'],
            ['35–55 min', 'Property and defect linkage: shrinkage, stiffness, opacity, warpage, sink, brittleness, drift.'],
            ['55–75 min', 'Process controls: mold temperature, pack/hold, gate seal, cooling, residence, drying, regrind.'],
            ['75–95 min', 'Cold runner vs hot runner: gate seal, residence, pack transmission, regrind, hot tips, valve gates.'],
    ...
    /* ───────── Section 23: SME Review Checklist (Manual §U, p 30) ───────── */
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ['Polymer science SME', 'Confirm definitions of lamellae, spherulites, tie molecules, Tg, Tm, nucleation, crystal growth, and Xc measurement.'],
            ['Processing SME', 'Validate process-variable matrix against internal molding standards and grade-specific experience.'],
            ['Tooling SME', 'Review mold-design section for gate, runner, cooling, venting, stack-mold, and hot-runner accuracy.'],
            ['Quality / Lab SME', 'Confirm DSC, density, XRD, microscopy, and measurement language aligns with lab capability.'],
            ['Safety SME', 'Review material-specific degradation warnings, especially POM, PVC, PET/PBT hydrolysis, and high-temp materials.'],
            ['Training owner', 'Decide which sections are mandatory for operators, setup technicians, process engineers, quality engineers, and managers.'],
            ['Plant owner', 'Add plant-specific reaction plans, job travelers, material handling rules, and approved setpoint ranges.'],
          ],
        },
        {
          type: 'callout',
